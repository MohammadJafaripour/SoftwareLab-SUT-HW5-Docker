...
- **کانتینر (Container):** یک نمونه در حال اجرا (Live Instance) و کاملاً ایزوله از یک ایمیج است. کانتینر یک لایه خواندن/نوشتن (Writable Layer) موقت به ایمیج اضافه کرده و برنامه را عملاً اجرا می‌کند.
